...
def tsv2feature(split):
    if split == 'train':
        infile = r'E:\mukea-out-data\data\trainval2014_36\train2014_obj36.tsv'
    elif split == 'val':
        infile = r'E:\mukea-out-data\data\trainval2014_36\val2014_obj36.tsv'
    in_data = {}
    objects_data = {}
    with open(infile, "r") as tsv_in_file:
        ...
        for item in tqdm(reader):
            ...
            # 这里是 Normalize the boxes (to 0 ~ 1)   研究了一下 这里是 对应位置相除
            ...
            # 添加box
            in_data[item['image_id']] = {'feats': item['features'], 'sp_feats': spatial_feature, 'boxes': item['boxes']}
